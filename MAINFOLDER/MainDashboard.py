...
button_urls = ["pages/AccusedData.py", "pages/VictimData.py", "pages/Crimedata.py", "pages/ModelDashboard.py"]  # Replace with actual URLs if needed
button_tooltips = [
...
st.title("Predictive Crime Analytics by Enigmatic Energizers")
st.write("")
st.write("")
st.write("")
st.write("")
