...
with st.expander("State View", expanded=st.session_state.tab_name == "State View"):
    ...
    with col_from_date:
        from_date_state = st.date_input("From Date (State)", value=min_date, min_value=min_date, max_value=max_date, key="from_date_state")
    with col_to_date:
        to_date_state = st.date_input("To Date (State)", value=max_date, min_value=from_date_state, max_value=max_date, key="to_date_state")
    ...
    if submit_button_state:
        ...
        heatmap_data_state = create_heatmap(selected_age_state, selected_sex_state, selected_from_year_state, selected_from_month_state, [])
